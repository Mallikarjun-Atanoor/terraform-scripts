...
resource "aws_cloudfront_origin_access_control" "oac_for_s3" {
  name                              = "oac-${var.s3_project_bucket}"
...
#access policy for bucket to allow cloudfront
...
resource "aws_s3_object" "upload_web_files" {
...
resource "aws_cloudfront_distribution" "s3_distribution" {
    ...
    origin_access_control_id = aws_cloudfront_origin_access_control.oac_for_s3.id
